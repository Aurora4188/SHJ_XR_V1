...
function updateSpringMeshes() {
  ...
  connections[0].pos.x = Math.sin(frame * circleSpeed) * circleRadius;
  connections[0].pos.z = Math.cos(frame * circleSpeed) * circleRadius;
  connections[0].pos.y = Math.sin(frame * circleSpeed * 0.5) * circleRadius * 0.5;
